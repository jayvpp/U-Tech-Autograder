...
app.controller("createTestController", function ($scope, $http, $timeout) {
    ...
    //check to see if questions were entered with all fields filed out
    function checkFields(correctAnswer, statement, score)
    {
        console.log("Fields:" + correctAnswer + statement + score);
        if (correctAnswer == "" || statement == "" || score == "") {
            submitFlag = "true";
        }
        else {
            submitFlag = "false";
    ...
    function retriveSingleChoiceQuestion()
    {
        ...
        for (i = 0 ; i < optionsCount; i++) {
            ...
            console.log("POSSIBLE ANSWERS:" + posOption);
            if (posOption = "") {submitFlag = "true";}
        ...
        checkFields(correctAnswer, $scope.statement, $scope.questionScore);
    ...
    $scope.addQuestion = function () {
        ...
        if ($scope.selected == "MultiSelect") {
            ...
            if (submitFlag == "true") {
                console.log("Improperly filled out question");
            }
            else {
